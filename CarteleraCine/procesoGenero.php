...
if($conn->conectar()){
    $sql = "SELECT peliculas.fotos,peliculas.titulo,peliculas.id_genero,generos.id,generos.nombre FROM peliculas,generos  WHERE generos.nombre=:genero AND peliculas.id_genero = generos.id LIMIT 0,6";
